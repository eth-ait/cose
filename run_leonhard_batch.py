...
experiment_list_rebuttal = [
    ...
    # 'python ink_training_eager_predictive.py '
    # '--comment "rel_spatial20-abs_pos-dist_cond-emb_1599069124.1" --gt_targets '
    # '--use_start_pos --num_pred_inputs 32 --stop_predictive_grad '
    # '--pred_input_type hybrid --stroke_loss nll_gmm --n_t_samples 4 '
    # '--batch_size 128 --affine_prob 0.3 --resampling_factor 2 --scale_factor 0 '
    # '--grad_clip_norm 1 '
    ...
    # '--loss_predicted_embedding --loss_reconstructed_ink '
    # '--data_name didi_wo_text --metadata_type position --disable_pen_loss '
    # '--mask_encoder_pen --pretrained_emb_id 1599069124.1 '
    # '--n_spatial_encodings 10 --inp_conditions --inp_target_dist_cond ',
    
    'python ink_training_eager_predictive.py '
    '--comment "400_10-end_pos_norm-shared_enc_dec-dist_cond-emb_mean_pool-emb_1599069124.1" --gt_targets '
    '--use_start_pos --num_pred_inputs 10 --stop_predictive_grad '
    '--pred_input_type hybrid --stroke_loss nll_gmm --n_t_samples 4 '
    '--batch_size 400 --affine_prob 0.3 --resampling_factor 2 --scale_factor 0 '
    '--grad_clip_norm 1 '
    '--encoder_model transformer --transformer_scale --transformer_pos_encoding '
    '--transformer_layers 6 --transformer_heads 4 --transformer_dmodel 64 '
    '--transformer_hidden_units 256 --transformer_dropout 0.0 --latent_units 8 '
    ...
    '--data_name didi_wo_text --metadata_type position --disable_pen_loss '
    '--mask_encoder_pen --pretrained_emb_id 1599069124.1 '
    '--n_spatial_encodings 0 --inp_conditions --inp_target_dist_cond '
    '--normalize_start_pos --p_use_encoder --pooling_layer mean --use_end_pos ',
    #
    'python ink_training_eager_predictive.py '
    '--comment "400_10-end_pos_norm-dist_cond-emb_mean_pool-emb_1599069124.1" --gt_targets '
    '--use_start_pos --num_pred_inputs 10 --stop_predictive_grad '
    '--pred_input_type hybrid --stroke_loss nll_gmm --n_t_samples 4 '
    '--batch_size 400 --affine_prob 0.3 --resampling_factor 2 --scale_factor 0 '
    '--grad_clip_norm 1 '
    ...
    '--mask_encoder_pen --pretrained_emb_id 1599069124.1 '
    '--n_spatial_encodings 0 --inp_conditions --inp_target_dist_cond '
    '--normalize_start_pos --pooling_layer mean --use_end_pos ',
    
    'python ink_training_eager_predictive.py '
    '--comment "500_10-end_pos_norm-dist_cond-emb_mean_pool-emb_1599069124.1" --gt_targets '
    '--use_start_pos --num_pred_inputs 10 --stop_predictive_grad '
    '--pred_input_type hybrid --stroke_loss nll_gmm --n_t_samples 4 '
    '--batch_size 500 --affine_prob 0.3 --resampling_factor 2 --scale_factor 0 '
    '--grad_clip_norm 1 '
    '--encoder_model transformer --transformer_scale --transformer_pos_encoding '
    '--transformer_layers 6 --transformer_heads 4 --transformer_dmodel 64 '
    '--transformer_hidden_units 256 --transformer_dropout 0.0 --latent_units 8 '
