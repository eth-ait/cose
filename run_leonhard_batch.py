...
experiment_list_rebuttal = [
    ...
    #
    # 'python ink_training_eager_predictive.py '
    # '--comment "rel_spatial20-abs_pos-dist_cond-mean_pool-emb_1599069124.1" --gt_targets '
    # '--use_start_pos --num_pred_inputs 32 --stop_predictive_grad '
    # '--pred_input_type hybrid --stroke_loss nll_gmm --n_t_samples 4 '
    # '--batch_size 128 --affine_prob 0.3 --resampling_factor 2 --scale_factor 0 '
    # '--grad_clip_norm 1 '
    ...
    'python ink_training_eager_predictive.py '
    '--comment "enc_abs_rel-dec_abs-abs_pos-dist_cond-emb_1599069124.1" --gt_targets '
    '--use_start_pos --num_pred_inputs 32 --stop_predictive_grad '
    '--pred_input_type hybrid --stroke_loss nll_gmm --n_t_samples 4 '
    '--batch_size 128 --affine_prob 0.3 --resampling_factor 2 --scale_factor 0 '
    '--grad_clip_norm 1 '
    ...
    'python ink_training_eager_predictive.py '
    '--comment "enc_abs_rel-dec_abs-abs_pos-dist_cond-mean_pool-emb_1599069124.1" --gt_targets '
    '--use_start_pos --num_pred_inputs 32 --stop_predictive_grad '
    '--pred_input_type hybrid --stroke_loss nll_gmm --n_t_samples 4 '
    '--batch_size 128 --affine_prob 0.3 --resampling_factor 2 --scale_factor 0 '
    '--grad_clip_norm 1 '
    ...
    '--mask_encoder_pen --pretrained_emb_id 1599069124.1 '
    '--n_spatial_encodings 10 --inp_conditions --inp_target_dist_cond '
    '--p_use_encoder --pooling_layer mean ',
    ]
